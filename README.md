...
<h3>NAME: Harini N</h3> 
<h3>REGISTER NO: 212223040057</h3>
<h3>EX. NO: 3</h3> 
<h3>DATE: 29/05/26</h3> 
...
## OUTPUT:
<img width="769" height="314" alt="image" src="https://github.com/user-attachments/assets/a52f0991-3d29-4390-a056-8f0b004867e5" />
...
CUDA (GPU)	~0.16 ms
Performance Analysis: From the results, it can be observed that the CUDA implementation provides significant performance improvement compared to the CPU implementation. As the image resolution increases, the processing time also increases. However, the GPU handles larger workloads efficiently due to parallel execution of threads. Increasing the block size improves GPU utilization up to a certain limit, after which the performance gain becomes minimal.
